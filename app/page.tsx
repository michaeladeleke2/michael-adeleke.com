...
import { HeroSpectrogram } from '@/components/hero-spectrogram'
  ...
  return (
    <>
      ...
      <section className="overflow-hidden border-b border-hairline">
        ...
        {/* The band sits in flow rather than behind the type, so its clearance
            holds at every width. It still bleeds the full page. */}
        <div className="pointer-events-none relative mt-12 h-44 sm:mt-8 sm:h-64 lg:h-72">
          <HeroSpectrogram />
